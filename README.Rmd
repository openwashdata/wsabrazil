...
ggplot() +
  ...
  scale_fill_gradient(name = "sector_type", low = "brown", high = "beige", breaks = c(0, 0.5, 1)) +
  labs(name = "sector_type", title = "Housing Conditions Across Municipalities") +
